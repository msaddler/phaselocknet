...
regex_eval="stimuli/sound_localization/evaluation/v01_eval_mit_bldg46room1004_tenoise/$DATA_TAG/*.tfrecords"
...
do
    regex_eval="stimuli/sound_localization/evaluation/$EXPT_TAG/$DATA_TAG/*.tfrecords"
